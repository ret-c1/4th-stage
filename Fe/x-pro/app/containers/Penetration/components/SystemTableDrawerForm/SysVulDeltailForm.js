                            ...
                            {SysData.sceneDescription ? (
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: SysData.sceneDescription, /* eslint-disable-line */
                                    }}
                                />
                            ) : (
                                '暂无'
                    ...
                    <Col span={12}>
                        <Form.Item label="内容描述及危害" name="contentDescription">
                            {SysData.contentDescription ? (
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: SysData.contentDescription, /* eslint-disable-line */
                                    }}
                                />
                            ) : (
                                '暂无'
                                ...
                                <Col span={12}>
                                    <Form.Item label="验证过程" name="testProcess">
                                        {item.testProcess ? (
                                            <div
                                                dangerouslySetInnerHTML={{
                                                    __html: item.testProcess, /* eslint-disable-line */
                                                }}
                                            />
                                        ) : (
                                            '暂无'
                                ...
                                <Col span={12}>
                                    <Form.Item label="修复建议" name="advice">
                                        {item.advice ? (
                                            <div
                                                dangerouslySetInnerHTML={{
                                                    __html: item.advice, /* eslint-disable-line */
                                                }}
                                            />
                                        ) : (
                                            '暂无'
