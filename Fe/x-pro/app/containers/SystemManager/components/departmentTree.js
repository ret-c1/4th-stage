...
import { Tree, Input, Button, Modal, Form, Radio } from 'antd';
import {
    PlusOutlined,
    EditOutlined,
    DeleteOutlined,
...
const DepartmentTree = (props) => {
    ...
    useEffect(() => {
        onCallback(pageTitle, departmentId || parseInt(searchParams().departId, 10));
    }, [departmentId || searchParams().departId]);
    ...
    const onSelect = (selectedKeys, e) => {
        const title = e.nativeEvent.target.textContent;
        setPageTitle(title);
