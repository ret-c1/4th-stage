...
const AddStaff = (props) => {
    ...
    console.log(setDepartChain, setPeopleList, setRole, setUserDetail);
    // 去重
    const distinct = (arr) =>
    ...
    const onFinish = (values) => {
        ...
        forParams.departId =
            (state && parseInt(state.departId, 10)) || (userDetail && userDetail.departId);
        ...
        if (state && state.stage) {
            if (state.stage === 'edit') {
                ...
                //         if (res.code === 200) {
                //             history.push(
                //                 `/system/staff?departId=${state && state.departId}&pageTitle=${
        ...
        <Card style={{ margin: 30 }}>
            ...
            >
                ...
                <Row>
                    <Col span={10}>
                        <Form.Item
                            ...
                            rules={[
                                {
                                    required: state && state.stage === 'add' && true,
                                    message: '请输入手机号!',
                                },
                            ]}
                        >
                        ...
                        <Col span={10}>
                            <Form.Item
                                ...
                                rules={[
                                    {
                                        required:
                                            state && state.stage === 'add' && !password && true,
                                        message: '请输入登录密码!',
                                    },
                                ]}
                            >
                ...
                <Row>
                    ...
                    <Col span={10}>
                        <Form.Item name="leaderUid" label="直属领导">
                            <Select showSearch>
                                {peopleList.map((item) => (
