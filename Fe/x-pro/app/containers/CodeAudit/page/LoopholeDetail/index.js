...
import { Table, Button, Card, Descriptions, Drawer } from 'antd';
...
const LoopholeDetail = () => {
    ...
    console.log(setTableList, setVulDetails, setVulProcessInfo, setTotal, changeLoading);
    return (
                ...
                <Descriptions title="基本详情" column={2}>
                        ...
                        {vulDetails && (
                            <div
                                dangerouslySetInnerHTML={{
                                    __html: vulDetails.descri, /* eslint-disable-line */
                                }}
                            />
                        )}
                    </Descriptions.Item>
                    <Descriptions.Item label="漏洞验证" key="confirm" span={2}>
                        {vulDetails && (
                            <div
                                dangerouslySetInnerHTML={{
                                    __html: vulDetails.confirm, /* eslint-disable-line */
                                }}
                            />
                        )}
                    </Descriptions.Item>
                    <Descriptions.Item label="修改方案" key="advice" span={2}>
                        {vulDetails && (
                            <div
                                dangerouslySetInnerHTML={{
                                    __html: vulDetails.advice, /* eslint-disable-line */
                                }}
                            />
                        )}
                    </Descriptions.Item>
