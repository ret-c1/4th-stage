...
export const GET_ASSET_KEY_ACTION = 'GET_ASSET_KEY_ACTION';
...
export const GET_TASK_LIST_FULFILLED = 'GET_TASK_LIST_FULFILLED';
...
// 威胁资产关键指标
export const getAssetKeyAction = (params) => (dispatch) => {
...
// 任务列表
export const getTaskListAction = (params) => (dispatch) => {
    dispatch({
