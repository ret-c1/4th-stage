        ...
        <>
            ...
            <ScCardDetail title="软件库信息" bordered={false}>
                <Descriptions>
                    ...
                    <Descriptions.Item label="代码项目名称" key="代码项目名称">
                        1.1.12.2
                    </Descriptions.Item>
                    <Descriptions.Item label="代码仓库地址SSH" key="代码仓库地址SSH" span={2}>
                        1.1.12.2
                    </Descriptions.Item>
                    <Descriptions.Item label="代码仓库内网端口号" key="代码仓库内网端口号">
                        mac
                    </Descriptions.Item>
                    <Descriptions.Item label="代码仓库地址SSH" key="代码仓库地址SSH" span={2}>
                        mac
...
export default compose(withConnect, memo)(ScmDetailsPage);
