...
const ApplicationDetailsPage = () => {
    ...
    return (
        <>
            ...
            <ScCardDetail title="软件信息" bordered={false}>
                <Descriptions>
                    <Descriptions.Item label="软件类型" key="软件类型">
                        oa系统
                    </Descriptions.Item>
                    <Descriptions.Item label="APP名称" key="APP名称">
                        这是
                    </Descriptions.Item>
                    ...
                    <Descriptions.Item label="注册人" key="注册人">
                        mac
                    </Descriptions.Item>
                </Descriptions>
            </ScCardDetail>
...
export default compose(withConnect, memo)(ApplicationDetailsPage);
