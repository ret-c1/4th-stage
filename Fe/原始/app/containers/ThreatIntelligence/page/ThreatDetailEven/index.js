...
const ThreatDetailEvenPage = (props) => {
    ...
    const html2pdf = () => {
        threatDownload({ id });
        // 这个是需要下载的 dom节点
        html2canvas(document.getElementById('event_pdf')).then((canvas) => {
    ...
    return (
        <div id="event_pdf">
            <PageHeader
                ...
                subTitle={<ScHeaderInfo>安全事件</ScHeaderInfo>}
                extra={
                    <>
                        {showEdit && (
                            <Button
            ...
            >
                <ScCardDetail title="基本信息">
                    <BasicInfo source="detaileven" detail={detail} threatProcess={threatProcess} />
                    <Row>
                        <Col span={24}>
                ...
                <ScCardDetail title="恶意样本分析结果">
                    <Analyse source="detaileven" detail={detail} />
                </ScCardDetail>
                <ScCardDetail
                    title="审批进度"
                    extra={
                    ...
                    <Row style={{ margin: '24px 0' }}>
                        <Col span={20}>
                            <Input
                                style={{ width: '100%' }}
                                id="text"
                                value={`${window.location.origin}/webapp/intelligence/threat/evendetail?flag=${detail.stixBundleId}&id=${id}&stage=detail&sourceType=1`}
                            />
                        </Col>
                        <Col span={4}>
                            <Button
...
ThreatDetailEvenPage.propTypes = {
...
export default compose(withConnect, memo)(ThreatDetailEvenPage);
